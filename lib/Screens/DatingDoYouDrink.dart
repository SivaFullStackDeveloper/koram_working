...
class DatingDoYouDrink extends StatefulWidget {
  const DatingDoYouDrink({key});

  @override
  State<DatingDoYouDrink> createState() => _DatingDoYouDrinkState();
}

class _DatingDoYouDrinkState extends State<DatingDoYouDrink> {
  List<String> DoYouDrinkOption = [
    "Frequently",
    'Socially',
    'Rarely',
    'Never',
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      for (String i in DoYouDrinkOption)
                        Padding(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Radio(
                                        value: i,
                                        groupValue: SelectedDrinkOption,
                                        onChanged: (e) {
                                          setState(() {
                                            SelectedDrinkOption = i;
                                          });
